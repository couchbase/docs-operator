...
On OpenShift:
```bash
$ oc create -f https://packages.couchbase.com/kubernetes/beta/secret.yaml
secret "cb-example-auth" created
```
...
On Kubernetes:
```bash
$ cbopctl create -f https://packages.couchbase.com/kubernetes/beta/couchbase-cluster.yaml
