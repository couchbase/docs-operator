...
When deploying the cluster in <<image-cluster-homogeneous-service-distribution>> using the Kubernetes Operator, the `CouchbaseCluster` configuration would include the following:
...
When deploying the cluster in <<image-cluster-heterogeneous-service-distribution>> using the Kubernetes Operator, the `CouchbaseCluster` configuration would include the following:
