...
a| https://hub.docker.com/r/couchbase/operator-backup[`operator-backup:1.3.2`^]
a| https://docs.couchbase.com/server/7.1/manage/manage-backup-and-restore/manage-backup-and-restore.html[`cbbackupmgr 7.1.3`^]
| Couchbase Server 6.6--7.1
|===
