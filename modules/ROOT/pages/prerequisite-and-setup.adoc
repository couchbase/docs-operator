...
a| https://hub.docker.com/r/couchbase/operator-backup[`operator-backup:1.5.0`^]
a| https://docs.couchbase.com/server/7.6/manage/manage-backup-and-restore/manage-backup-and-restore.html[`cbbackupmgr 7.6.8`^]
