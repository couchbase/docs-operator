...
This annotation controls whether operator and dynamic admission controller requires short name entries as part of the SAN list in Couchbase Server TLS Certificates.
It defaults to `true`.
