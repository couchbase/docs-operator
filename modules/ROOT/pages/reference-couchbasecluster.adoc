...
Specified environment variables will be available in Couchbase server containers only.
The envFrom filed is defined by the Kubernetes https://v1-17.docs.kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#envfromsource-v1-core[`EnvFromSource`^] type.
