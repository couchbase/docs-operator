...
This guide walks through the recommended procedure for installing the Couchbase Autonomous Operator in a Red Hat OpenShift project.
...
$ oc create -f https://packages.couchbase.com/kubernetes/0.9/openshift/crd.yaml
----
...
[source,console]
----
oc create -f https://packages.couchbase.com/kubernetes/0.9/openshift/cluster-role-sa.yaml
----
...
[source,console]
----
oc create -f https://packages.couchbase.com/kubernetes/0.9/openshift/cluster-role-user.yaml
----
...
[source,console]
----
oc create -f https://packages.couchbase.com/kubernetes/0.9/openshift/operator.yaml
----
