...
[source,console]
----
$ bin/cbopcfg admission --cluster --image-pull-secret rh-catalog | kubectl create -f -
$ bin/cbopcfg operator --image-pull-secret rh-catalog | kubectl create -f -
----
...
----
$ oc project camelot
$ bin/cbopcfg admission --cluster --image-pull-secret rh-catalog | oc create -f -
----
...
----
$ oc project asgard
$ bin/cbopcfg operator --image-pull-secret rh-catalog | oc create -f -
----
