...
The following command will install both the DAC and the Operator in the `default` namespace:

[source,console]
----
$ bin/cbopcfg generate admission --image-pull-secret rh-catalog | oc create -f -
$ bin/cbopcfg generate operator --image-pull-secret rh-catalog | oc create -f -
----
...
[source,console]
----
$ bin/cbopcfg generate admission --namespace camelot --image-pull-secret rh-catalog | oc create -f -
----
...
[source,console]
----
$ bin/cbopcfg generate operator --namespace asgard --image-pull-secret rh-catalog | oc create -f -
----
...
[source,console]
----
$ bin/cbopcfg generate operator | oc delete -f -
$ bin/cbopcfg generate admission | oc delete -f -
