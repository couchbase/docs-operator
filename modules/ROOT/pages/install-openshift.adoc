...
[source,console]
----
$ ./cbopcfg --image-pull-secret rh-catalog | kubectl create -f -
----
...
----
$ oc project camelot
$ ./cbopcfg --no-operator --image-pull-secret rh-catalog | oc create -f -
----
...
----
$ oc project asgard
$ ./cbopcfg --no-admission --image-pull-secret rh-catalog | oc create -f -
----
