...
[source,console]
----
$ bin/cbopcfg generate admission --image-pull-secret rh-catalog | kubectl create -f -
$ bin/cbopcfg generate operator --image-pull-secret rh-catalog | kubectl create -f -
----
...
[source,console]
----
$ bin/cbopcfg generate operator | kubectl delete -f -
$ bin/cbopcfg generate admission | kubectl delete -f -
