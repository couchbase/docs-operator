...
An expansion event has failed for a specific persistent volume.
All subsequent volume expansion requests are canceled and cluster falls back to rolling upgrade of volumes.
