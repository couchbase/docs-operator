...
[source,console]
----
$ curl -O https://packages.couchbase.com/kubernetes/1.0.0/darwin/cbopctl
...
[source,console]
----
$ curl -O https://packages.couchbase.com/kubernetes/1.0.0/linux/cbopctl
...
[source,console]
----
$ curl -O https://packages.couchbase.com/kubernetes/1.0.0/windows/cbopctl
$ chmod +x cbopctl
----
