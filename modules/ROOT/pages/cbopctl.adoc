...
[source,console]
----
$ curl -O https://packages.couchbase.com/kubernetes/0.9.0-beta3/darwin/cbopctl
...
[source,console]
----
$ curl -O https://packages.couchbase.com/kubernetes/0.9.0-beta3/linux/cbopctl
...
[source,console]
----
$ curl -O https://packages.couchbase.com/kubernetes/0.9.0-beta3/windows/cbopctl
$ chmod +x cbopctl
----
