...
+
--
. Open a Terminal window and go to the directory where the `cbopctl` binary is located:
+
[source,console]
----
...
+
--
. Open a command prompt and go to the directory where the `cbopctl` binary is located:
+
[source,console]
----
...
. Add the `cbopctl` binary into your PATH.
--
====
