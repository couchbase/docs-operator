...
[WARNING]
====
The Operator should not be upgraded while any Couchbase clusters are in hibernation. Instructions to wake the cluster can be found in the https://docs.couchbase.com/operator/current/concept-hibernation.html[hibernation] documentation.
====
