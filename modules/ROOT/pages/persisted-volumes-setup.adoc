...
This topic outlines how to set up Kubernetes for the https://kubernetes.io/docs/concepts/storage/dynamic-provisioning/[dynamic provisioning] of Persistent Volumes. Only dynamic volume provisioning using storage classes is currently supported.
...
Once you've created a storage class, you can verify its ability to provide volumes by creating a https://kubernetes.io/docs/concepts/storage/persistent-volumes/#persistentvolumeclaims[Persistent Volume Claim (PVC)]. The following example creates a claim that will use your storage class to provide persistent volumes:
