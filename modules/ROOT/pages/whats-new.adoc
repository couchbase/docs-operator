= What's New in Couchbase Autonomous Operator 2.9

Couchbase Autonomous Operator 2.9.0 was released in December 2025.
...
Couchbase Autonomous Operator (CAO) 2.9.0 adds support for Couchbase Server 8.0 features and
...
Couchbase Server 8.0 introduces several key features, listed in xref:server:introduction:whats-new.adoc[What's New in Version 8.0], which are now configurable through CAO 2.9.0.
