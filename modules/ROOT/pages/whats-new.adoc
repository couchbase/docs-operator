...
[#whats-new-290]
== New Features and Enhancements in 2.9

Couchbase Kubernetes Operator 2.9 adds support for Couchbase Server 8.0 features and
...
Couchbase Server 8.0 introduces several key features, listed in xref:server:introduction:whats-new.adoc[What's New in Version 8.0], which are now configurable through Couchbase Kubernetes Operator 2.9.
