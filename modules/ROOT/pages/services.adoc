...
TIP: Pods will be created with the `cluster.local` suffix in the search path, so you may use the short form `couchbase-0000.couchbase.default.srv` to reference individual pods.
...
NOTE: For further information on connecting clients please refer to the xref:couchbase-clients.adoc[full documentation].
...
NOTE: For further information on configuring the admin console please refer to the xref:reference-couchbasecluster.adoc[full documentation].

== couchbase-0000-exposed-ports
...
NOTE: For further information on exposing features please refer to the xref:couchbase-clients.adoc[full documentation].

NOTE: For further information on networking please refer to the xref:networking.adoc[full documentation].
