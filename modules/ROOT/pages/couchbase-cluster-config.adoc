...
If set to `true`, the Operator will search for xref:couchbase-rolebinding-config.adoc[`CouchbaseRoleBinding`] resources in the namespace under the control of the <<spec-security-rbac-selector,`spec.security.rbac.selector`>> field.
...
This field specifies which xref:couchbase-rolebinding-config.adoc[`CouchbaseRoleBinding`] resources are considered when the <<spec-security-rbac-managed,`spec.security.rbac.managed`>> field is set to `true`.
If not specified all xref:couchbase-rolebinding-config.adoc[`CouchbaseRoleBinding`] resources are selected.
If specified, then only xref:couchbase-rolebinding-config.adoc[`CouchbaseRoleBinding`] resources containing the same labels as specified in the label selector are selected.
...
If set to `true`, the Operator will search for xref:couchbase-bucket-config.adoc[`CouchbaseBucket`], xref:couchbase-ephemeral-bucket-config.adoc[`CouchbaseEphemeralBucket`] and xref:couchbase-memcached-bucket-config.adoc[`CouchbaseMemcachedBucket`] resources in the namespace under the control of the <<spec-buckets-selector,`spec.buckets.selector`>> field.
...
This field specifies which xref:couchbase-bucket-config.adoc[`CouchbaseBucket`], xref:couchbase-ephemeral-bucket-config.adoc[`CouchbaseEphemeralBucket`] and xref:couchbase-memcached-bucket-config.adoc[`CouchbaseMemcachedBucket`] resources are considered when the <<spec-buckets-managed,`spec.buckets.managed`>> field is set to `true`.
If not specified all xref:couchbase-bucket-config.adoc[`CouchbaseBucket`], xref:couchbase-ephemeral-bucket-config.adoc[`CouchbaseEphemeralBucket`] and xref:couchbase-memcached-bucket-config.adoc[`CouchbaseMemcachedBucket`] resources are selected.
If specified, then only xref:couchbase-bucket-config.adoc[`CouchbaseBucket`], xref:couchbase-ephemeral-bucket-config.adoc[`CouchbaseEphemeralBucket`] and xref:couchbase-memcached-bucket-config.adoc[`CouchbaseMemcachedBucket`] resources containing the same labels as specified in the label selector are selected.
...
This field defines a label selector to choose which xref:couchbase-replication-config.adoc[`CouchbaseReplication`] resources should be included for this remote cluster.
