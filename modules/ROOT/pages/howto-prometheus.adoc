...
Refer to the https://prometheus-operator.dev/docs/operator/api/#tlsconfig[TLS Config Reference] documentation for supported attributes.
In production you should ensure that your client cetificates are signed by the same root CA that is installed within the Couchbase Server.
