...
Refer to the https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.SafeTLSConfig[TLS Configuration Reference] documentation for supported attributes.
