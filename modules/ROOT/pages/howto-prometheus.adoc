...
[abstract]
You can set up the Autonomous Operator to use the Couchbase Server's native support for metrics collection.
...
[WARNING]
====
Use of Prometheus exporter is deprecated and will be removed in a future release.
