...
To install the Prometheus Operator stack follow the https://github.com/prometheus-operator/kube-prometheus#quickstart["Quckstart Documentation"^].
...
Save as `couchbase-prometheus-monitor.yaml` after mking any necessary modifications as described below:
