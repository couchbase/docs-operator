...
Refer to the https://prometheus-operator.dev/docs/operator/api/#tlsconfig[TLS Configuration Reference] documentation for supported attributes.
...
[source,console]
----
$ kubectl apply -f couchbase-prometheus-monitor.yaml -n monitoring`
----
