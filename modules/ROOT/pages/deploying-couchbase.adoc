...
+
NOTE: In this example, bucket management for the cluster (`spec.buckets.managed`) is set to `true`, meaning that the Autonomous Operator will handle the creation and deletion of Couchbase buckets.
