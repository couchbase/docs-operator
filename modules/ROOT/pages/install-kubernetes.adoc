...
[source,console]
----
kubectl create -f https://packages.couchbase.com/kubernetes/0.9/k8s-rbac/cluster-role.yaml
----
...
[source,console]
----
kubectl create -f https://packages.couchbase.com/kubernetes/0.9/k8s-rbac/operator.yaml
----
