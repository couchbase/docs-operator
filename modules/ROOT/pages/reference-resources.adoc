...
Couchbase resources are documented entirely using Kubernetes to reduce duplication of effort.
Accessing the documentation requires the resource type and a JSON path.
...
You can descend through the resource configuration by making the JSON path more specific.
For example:
