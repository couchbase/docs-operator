...
[source,console]
----
$ cbopctl apply -f  https://packages.couchbase.com/kubernetes/0.9.0-beta3/couchbase-cluster.yaml
...
[source,console]
----
$ kubectl create -f https://packages.couchbase.com/kubernetes/0.9.0-beta3/couchbase-cli-create-user.yaml
...
[source,console]
----
$ oc create -f https://packages.couchbase.com/kubernetes/0.9.0-beta3/couchbase-cli-create-user.yaml
job "create-user" created
...
[source,yaml]
----
https://packages.couchbase.com/kubernetes/0.9.0-beta3/couchbase-cli-create-user.yaml
---
apiVersion: batch/v1
kind: Job
metadata:
...
[source,console]
----
$ kubectl create -f https://packages.couchbase.com/kubernetes/0.9.0-beta3/pillowfight-data-loader.yaml
...
[source,console]
----
$ oc create -f https://packages.couchbase.com/kubernetes/0.9.0-beta3/pillowfight-data-loader-openshift.yaml
job "pillowfight" created
----
