...
* See xref:admin-console-access.adoc[Accessing the Couchbase Web Console] for exposing the Web Console.
...
[source,console]
----
$ kubectl create -f https://packages.couchbase.com/kubernetes/0.9.0-beta3/couchbase-cli-collect-logs.yaml
...
[source,console]
----
$ oc create -f https://packages.couchbase.com/kubernetes/0.9.0-beta3/couchbase-cli-collect-logs.yaml
----
