...
All of the remaining values which can be overridden in this spec are desccribed here in the xref:reference-couchbasecluster.adoc[Couchbase Cluster Config] documentation.
