...
Provide a string that includes any values supported by https://docs.couchbase.com/server/current/backup-restore/cbbackupmgr-backup.html[`cbbackupmgr`].
...
Provide a string that includes any values supported by https://docs.couchbase.com/server/current/backup-restore/cbbackupmgr-merge.html[`cbbackupmgr`].
