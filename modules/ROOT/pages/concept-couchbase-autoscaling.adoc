...
This is accomplished by defining the `scaleTargetRef` settings within https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#horizontalpodautoscalerspec-v2-autoscaling[`HorizontalPodAutoscalerSpec`^]:
...
<.> When targeting Couchbase metrics, https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#metrictarget-v2-autoscaling[`MetricSpec`^] must be set to `type: Pods`.

<.> The https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#metricidentifier-v2-autoscaling[`MetricIdentifier`^] must include the name of the Couchbase metric to target for monitoring.
...
<.> When targeting Couchbase metrics, the https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#metrictarget-v2-autoscaling[`MetricTarget`^] should be set to `type: AverageValue` so that the metric is averaged across all of the pods in the relevant server class.
...
A label selector is defined in the https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#metricidentifier-v2-autoscaling[`MetricIdentifier`^] and gets passed as an additional parameter to the metrics server so that metrics can be individually scoped.
...
<.> The https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#metricidentifier-v2-autoscaling[`MetricIdentifier`^] is now defined with a label selector.
...
<.> When targeting Kubernetes resource metrics, https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#metrictarget-v2-autoscaling[`MetricSpec`^] must be set to `type: Resource`.

<.> The https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#resourcemetricsource-v2-autoscaling[`ResourceMetricSource`^] must include the name of the Kubernetes resource metric (e.g. `cpu` and `memory`) to target for monitoring.
In this example, `cpu` is specified, which is a metric that measures the pod CPU usage as a percentage.

<.> When targeting Kubernetes resource metrics, the https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#metrictarget-v2-autoscaling[`MetricTarget`^] should be set to `type: Utilization` so that the metric is averaged across all of the pods in the relevant server class.
...
Specifically, defining `minReplicas` and `maxReplicas` within the https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#horizontalpodautoscalerspec-v2-autoscaling[`HorizontalPodAutoscalerSpec`^] sets lower and upper boundaries for the size of the server class.
...
These behaviors are configured via _policies_ specified in the `behavior` field in the https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.25/#horizontalpodautoscalerspec-v2-autoscaling[`HorizontalPodAutoscalerSpec`^].
