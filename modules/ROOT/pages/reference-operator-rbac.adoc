...
However, the xref:tools/cbopinfo.adoc[`cbopinfo`] tool -- specifically the xref:tools/cbopinfo.adoc#options[`--collectinfo`] option -- _does_ require `pods/exec` permissions.
