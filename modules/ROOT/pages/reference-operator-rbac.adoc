...
If this is not acceptable, then please refer to xref:concept-couchbase-logging.adoc[] for additional options that ensure log availability (such as xref:concept-couchbase-logging.adoc#log-streaming[log streaming]).
====
