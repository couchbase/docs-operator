...
These backup jobs execute a helper script to perform logging and cleanup, as well as launch the xref:server:backup-restore:cbbackupmgr.adoc[`cbbackupmgr`] utility to perform backup and restore.
