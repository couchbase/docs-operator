...
If the required permissions are too permissive for your environment then you can selectively remove them with the xref:tools/cbopcfg.adoc[`cbopcfg`] installer tool.
