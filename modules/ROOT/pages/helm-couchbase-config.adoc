...
All of the remaining values which can be overridden in this spec are described here in the xref:reference-couchbasecluster.adoc[Couchbase Cluster Configuration] documentation.
...
Refer to xref:reference-couchbasegroup.adoc[Couchbase Groups] for list of Administrator and Bucket roles.
