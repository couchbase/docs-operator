...
cluster:
  ...
  name:
  # image is the base Couchbase Server Enterprise Edition image and version of the Couchbase cluster
...
# Couchbase buckets to automatically create and manage
# A default bucket is created unless you configure one, or otherwise set `buckets: null` in the values file or `buckets=null` on the command line.
buckets:
  # The name of the default bucket object in Kubernetes
  default:
    # Kind of bucket
    kind: CouchbaseBucket
    # Name of the bucket within Couchbase server, defaults to the object name
    name: default
