...
[source,console,subs="attributes,verbatim"]
----
helm install mobile --set install.syncGateway=true {helm-repo}
----
...
[source,console,subs="attributes,verbatim"]
----
helm install mobile --set install.syncGateway=true --set syncGateway.exposeServiceType=LoadBalancer {helm-repo}
----
