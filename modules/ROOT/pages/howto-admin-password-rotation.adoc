...
The administrator user secret is defined by the xref:reference-couchbasecluster.adoc#spec-security-adminsecret[`spec.security.adminSecret`] attribute in a `CouchbaseCluster` resource:
