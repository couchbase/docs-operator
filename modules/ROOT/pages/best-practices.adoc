...
In this mode of operation, the Operator can recover a partially down cluster -- where Couchbase server is unable to automatically failover the pods -- by xref:reference-couchbasecluster.adoc#spec-recoverypolicy[forcing the down pods out of the cluster].
