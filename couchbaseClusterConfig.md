...
- [Spec: The Top-Level](#spec-the-top-level)
	...
	- [exposeAdminConsole](#exposeadminconsole)
	- [adminConsoleServices](#adminconsoleservices)
  - [exposedFeatures](#exposedfeatures)
  - [softwareUpdateNotifications](#softwareupdatenotifications)
  - [serverGroups](#servergroups)
- [Spec: The Cluster Settings](#spec-the-cluster-settings)
	- [dataServiceMemoryQuota](#dataservicememoryquota)
	- [indexServiceMemoryQuota](#indexservicememoryquota)
	- [searchServiceMemoryQuota](#searchservicememoryquota)
  - [eventingServiceMemoryQuota](#eventingservicememoryquota)
  - [analyticsServiceMemoryQuota](#analyticsservicememoryquota)
...
- [Spec: Bucket Settings](#spec-bucket-settings)
	...
	- [enableIndexReplicas](#enableindexreplicas)
...
For more information, see the Kubernetes documentation about [labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/).
